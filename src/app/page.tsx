    ...
    <div className="min-h-screen bg-gradient-to-b from-base-100 to-base-200">
      ...
      <nav className="navbar sticky top-0 z-50 bg-base-100/80 backdrop-blur-lg border-b border-base-200">
        <div className="navbar-start">
          <a className="text-xl font-bold text-primary" href="/">行途</a>
        </div>
      ...
      <footer className="footer footer-center p-10 bg-base-200 text-base-content">
        <nav className="grid grid-flow-col gap-6">
          <button className="link link-hover" type="button" onClick={() => setModal("about")}>关于我们</button>
          <button className="link link-hover" type="button" onClick={() => setModal("privacy")}>隐私政策</button>
          <button className="link link-hover" type="button" onClick={() => setModal("terms")}>使用条款</button>
          <a className="link link-hover" href="mailto:hi@gonomads.app">联系我们</a>
        </nav>
        <nav>
          <div className="grid grid-flow-col gap-4">
              <a href="https://x.com" className="btn btn-ghost btn-circle" aria-label="访问 X" target="_blank" rel="noreferrer noopener">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current" aria-hidden="true">
                ...
                <span className="sr-only">访问 X</span>
            </a>
            <a href="https://instagram.com" className="btn btn-ghost btn-circle" aria-label="访问 Instagram" target="_blank" rel="noreferrer noopener">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current" aria-hidden="true">
                ...
                <span className="sr-only">访问 Instagram</span>
            </a>
          </div>
        </nav>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center">
              {/* biome-ignore lint/performance/noImgElement: QR 生成接口返回位图 */}
              <img
